...
namespace Blend.ui {
    ...
    /**
     * Common base class for a UI View component
     */
    export abstract class ContainerBase extends Blend.ui.View {

        protected items: Array<Blend.ui.View | Blend.ui.ContainerBase>;
