...
define("BuilderBase", ["require", "exports", 'fs', 'fs-extra', 'del', 'path', 'child_process', 'version-comparison'], function (require, exports, fs, fse, del, path, childProcess, version_comparison_1) {
    "use strict";
    var BuilderBase = (function () {
        function BuilderBase(rootFolder) {
            ...
            this.checkTypeScriptSanity = function (callback) {
                ...
                childProcess.exec('tsc -v', { cwd: me.rootFolder }, function (error, stdout, stderr) {
                    if (!error) {
                        ...
                        if (version_comparison_1.vercompare(parts[1], me.minTypeScriptVersion) !== -1) {
            ...
            this.copyrightFiles = function (folder, extensions) {
                ...
                var me = this, count = 0, header = me.copyrightHeader.join("\n");
                extensions = extensions || ['.ts', 'scss'];
                var files = me.readFiles(folder, function (fname) {
         ...
         */
        BuilderBase.prototype.fileExists = function (path) {
            try {
        ...
        BuilderBase.prototype.fixPath = function (value) {
            return value.replace('/', path.sep);
        };
        /**
         * Copy file from source to dest
         */
        BuilderBase.prototype.copyFile = function (source, dest) {
         ...
         */
        BuilderBase.prototype.readFiles = function (dir, filter) {
            var me = this, results = [];
        ...
        BuilderBase.prototype.downloadFile = function (source, dest, callback) {
         ...
         */
        BuilderBase.prototype.runSerial = function (callbacks, whenDone) {
            var me = this;
         ...
         */
        BuilderBase.prototype.downloadFiles = function (files, callback) {
         ...
         */
        BuilderBase.prototype.reCreateFolder = function (folder) {
            var me = this;
         ...
         */
        BuilderBase.prototype.dirExists = function (path) {
            try {
                var stat = fs.statSync(path);
                if (stat) {
         ...
         */
        BuilderBase.prototype.checkCURLSanity = function (callback) {
            var me = this;
         ...
         * Checks if compass exists and it is the correct version.
         */
        BuilderBase.prototype.checkCompassSanity = function (callback) {
            var me = this;
            ...
            childProcess.exec('compass -v', { cwd: me.rootFolder }, function (error, stdout, stderr) {
                if (!error) {
                    ...
                    if (version_comparison_1.vercompare(parts[1], me.minCompassVersion) !== -1) {
                        callback.apply(me, [null]);
                    }
                    else {
         ...
         */
        BuilderBase.prototype.cleanBuild = function (callback) {
            var me = this;
            try {
...
define("BlendCmd", ["require", "exports", 'child_process', "BuilderBase"], function (require, exports, childProcess, BuilderBase_1) {
    "use strict";
    var BlendCmd = (function (_super) {
        __extends(BlendCmd, _super);
        function BlendCmd(rootFolder) {
         ...
         */
        BlendCmd.prototype.buildStyles = function (callback) {
            var me = this;
         ...
         */
        BlendCmd.prototype.buildBlend = function (callback) {
            var me = this;
        ...
        BlendCmd.prototype.getESPromiseLibrary = function (callback) {
            var me = this, files = [
                {
         ...
         */
        BlendCmd.prototype.prepareTests = function (callback) {
         ...
         */
        BlendCmd.prototype.buildFramework = function () {
            var me = this;
         ...
         * Build entry point
         */
        BlendCmd.prototype.run = function () {
        ...
        return BlendCmd;
    }(BuilderBase_1.BuilderBase));
    exports.BlendCmd = BlendCmd;
});
